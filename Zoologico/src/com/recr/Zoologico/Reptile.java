...
public class Reptile extends Vertebrate implements Walks{
	
		private int fangs;
		private int extremities;
		private String kind;		

		public Reptile(int fangs, int extremities,  String kind, int bone, int eyes,  String name, String habit, String size, String sex, int age) {
			this.fangs = fangs;
